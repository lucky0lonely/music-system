(function (){
    ...
    window.songArr = [{
            ...
            songUrl : 'http://www.dbegin.cn/music/你,好不好.m4a'
        },{
            name : '搁浅',
            title : '搁浅',
            author : '周杰伦',
            ...
            songUrl : 'http://www.dbegin.cn/music/搁浅.m4a'
        },{
            name : '慢慢喜欢你',
            title : '慢慢喜欢你',
            author : '莫文蔚',
            ...
            songUrl : 'http://www.dbegin.cn/music/慢慢喜欢你.m4a'
        },{
            name : '年少有为',
            title : '年少有为',
            author : '李荣浩',
            ...
            songUrl : 'http://www.dbegin.cn/music/年少有为.m4a'
        },{
            name : '绿色',
            title : '绿色',
            author : '陈雪凝',
            ...
            songUrl : 'http://www.dbegin.cn/music/绿色.m4a'
        },{
            name : '刚刚好',
            title : '刚刚好',
            author : '薛之谦',
            ...
            songUrl : 'http://www.dbegin.cn/music/刚刚好.m4a'
        },{
            name : '我好像在哪见过你',
            title : '我好像在哪见过你',
            author : '薛之谦',
            album : '《初学者》',
            songImg : 'bin/images/zhi.jpg',
            songUrl : 'http://www.dbegin.cn/music/我好像在哪见过你.m4a'
        },{
            name : '方圆几里',
            title : '方圆几里',
            author : '薛之谦',
            album : '《意外》',
            songImg : 'bin/images/zhi.jpg',
            songUrl : 'http://www.dbegin.cn/music/方圆几里.m4a'
        },{
            name : '其实',
            title : '其实',
            author : '薛之谦',
            album : '《意外》',
            songImg : 'bin/images/zhi.jpg',
            songUrl : 'http://www.dbegin.cn/music/其实.m4a'
        },{
            name : '下雨了',
            title : '下雨了',
            author : '薛之谦',
            album : '《绅士》',
            songImg : 'bin/images/zhi.jpg',
            songUrl : 'http://www.dbegin.cn/music/下雨了.m4a'
        },{
            name : '光年之外',
            title : '光年之外',
            author : '邓紫棋',
            ...
            songUrl : 'http://www.dbegin.cn/music/光年之外.m4a'
        },{
            name : '喜欢你',
            title : '喜欢你',
            author : '邓紫棋',
            album : '《喜欢你》',
            songImg : 'bin/images/zi.jpg',
            songUrl : 'http://www.dbegin.cn/music/喜欢你.m4a'
        },{
            name : '可惜没如果',
            title : '可惜没如果',
            author : '林俊杰',
            ...
            songUrl : 'http://www.dbegin.cn/music/可惜没如果.m4a'
        },{
            name : '修炼爱情',
            title : '修炼爱情',
            author : '林俊杰',
            album : '《因你而在》',
            songImg : 'bin/images/jun.jpg',
            songUrl : 'http://www.dbegin.cn/music/修炼爱情.m4a'
        },{
            name : '她说',
            title : '她说',
            author : '林俊杰',
            album : '《她说 概念自选辑》',
            songImg : 'bin/images/jun.jpg',
            songUrl : 'http://www.dbegin.cn/music/她说.m4a'
        },{
            name : 'Alone',
            title : 'Alone',
            author : 'Alan Walker',
            ...
            songUrl : 'http://www.dbegin.cn/music/Alone.m4a'
        },{
            name : '等你下课(with 杨瑞代)',
            title : '等你下课(with 杨瑞代)',
            author : '周杰伦',
            album : '《等你下课》',
            songImg : 'bin/images/jie.jpg',
            songUrl : 'http://www.dbegin.cn/music/等你下课(with 杨瑞代).m4a'
        },{
            name : '彩虹',
            title : '彩虹',
            author : '周杰伦',
            album : '《我很忙》',
            songImg : 'bin/images/jie.jpg',
            songUrl : 'http://www.dbegin.cn/music/彩虹.m4a'
        },{
            name : '那个男孩',
            title : '那个男孩',
            author : '汪苏泷',
            ...
            songUrl : 'http://www.dbegin.cn/music/那个男孩.m4a'
        }
    ];
    init();
    function init(){
